...
public static partial class ffmpeg
{
    ...
    static ffmpeg()
    {
        ...
        // DynamicallyLoadedBindings.Initialize(); // Not available in unified bindings
    }
    ...
    public static long INT64_C<T>(T a)
        => Convert.ToInt64(a);
    ...
    public static int MKBETAG<T1, T2, T3, T4>(T1 a, T2 b, T3 c, T4 d)
        => (int)(Convert.ToUInt32(d) | (Convert.ToUInt32(c) << 8) | (Convert.ToUInt32(b) << 16) |
                 (Convert.ToUInt32(a) << 24));
