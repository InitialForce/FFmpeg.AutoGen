...
public unsafe struct __va_list_tag1 : IFixedArray<__va_list_tag>
{
    public static readonly int ArrayLength = 1;
    public int Length => 1;
    __va_list_tag _0;

    public __va_list_tag this[uint i]
    {
        get { if (i >= 1) throw new ArgumentOutOfRangeException(); fixed (__va_list_tag* p0 = &_0) { return *(p0 + i); } }
        set { if (i >= 1) throw new ArgumentOutOfRangeException(); fixed (__va_list_tag* p0 = &_0) { *(p0 + i) = value;  } }
    }
    public __va_list_tag[] ToArray()
    {
        fixed (__va_list_tag* p0 = &_0) { var a = new __va_list_tag[1]; for (uint i = 0; i < 1; i++) a[i] = *(p0 + i); return a; }
    }
    public void UpdateFrom(__va_list_tag[] array)
    {
        fixed (__va_list_tag* p0 = &_0) { uint i = 0; foreach(var value in array) { *(p0 + i++) = value; if (i >= 1) return; } }
    }
    public unsafe Span<__va_list_tag> GetPinnableReference()
    {
        fixed (__va_list_tag* p = &_0) return new Span<__va_list_tag>(p, 1);
    }
    public static implicit operator __va_list_tag[](__va_list_tag1 @struct) => @struct.ToArray();
}

public unsafe struct byte1 : IFixedArray<byte>
{
    public static readonly int ArrayLength = 1;
    public int Length => 1;
    fixed byte _[1];
    ...
    public byte[] ToArray()
    {
        var a = new byte[1]; for (uint i = 0; i < 1; i++) a[i] = _[i]; return a;
    }
    public void UpdateFrom(byte[] array)
    {
        uint i = 0; foreach(var value in array) { _[i++] = value; if (i >= 1) return; }
    }
    public unsafe Span<byte> GetPinnableReference()
    {
        fixed (byte* p = &_[0]) return new Span<byte>(p, 1);
    }
    public static implicit operator byte[](byte1 @struct) => @struct.ToArray();
}
...
public unsafe struct AVRational2 : IFixedArray<AVRational>
{
    ...
    public unsafe Span<AVRational> GetPinnableReference()
    {
        fixed (AVRational* p = &_0) return new Span<AVRational>(p, 2);
    }
...
public unsafe struct short2 : IFixedArray<short>
{
    ...
    public unsafe Span<short> GetPinnableReference()
    {
        fixed (short* p = &_[0]) return new Span<short>(p, 2);
    }
...
public unsafe struct void_ptr2 : IFixedArray
{
    ...
    {
        fixed (void** p = &_0) return new Span<IntPtr>(p, 2);
    }
...
public unsafe struct AVHDRPlusColorTransformParams3 : IFixedArray<AVHDRPlusColorTransformParams>
{
    ...
    public unsafe Span<AVHDRPlusColorTransformParams> GetPinnableReference()
    {
        fixed (AVHDRPlusColorTransformParams* p = &_0) return new Span<AVHDRPlusColorTransformParams>(p, 3);
    }
...
public unsafe struct AVRational3 : IFixedArray<AVRational>
{
    ...
    public unsafe Span<AVRational> GetPinnableReference()
    {
        fixed (AVRational* p = &_0) return new Span<AVRational>(p, 3);
    }
...
public unsafe struct AVRational3x2 : IFixedArray<AVRational2>
{
    ...
    public unsafe Span<AVRational2> GetPinnableReference()
    {
        fixed (AVRational2* p = &_0) return new Span<AVRational2>(p, 3);
    }
...
public unsafe struct short3x2 : IFixedArray<short2>
{
    ...
    public unsafe Span<short2> GetPinnableReference()
    {
        fixed (short2* p = &_0) return new Span<short2>(p, 3);
    }
...
public unsafe struct AVComponentDescriptor4 : IFixedArray<AVComponentDescriptor>
{
    ...
    public unsafe Span<AVComponentDescriptor> GetPinnableReference()
    {
        fixed (AVComponentDescriptor* p = &_0) return new Span<AVComponentDescriptor>(p, 4);
    }
...
public unsafe struct byte_ptr4 : IFixedArray
{
    ...
    public unsafe Span<IntPtr> GetPinnableReference()
    {
        fixed (byte** p = &_0) return new Span<IntPtr>(p, 4);
    }
...
public unsafe struct byte4 : IFixedArray<byte>
{
    ...
    public unsafe Span<byte> GetPinnableReference()
    {
        fixed (byte* p = &_[0]) return new Span<byte>(p, 4);
    }
...
public unsafe struct int4 : IFixedArray<int>
{
    ...
    public unsafe Span<int> GetPinnableReference()
    {
        fixed (int* p = &_[0]) return new Span<int>(p, 4);
    }
...
public unsafe struct long4 : IFixedArray<long>
{
    ...
    public unsafe Span<long> GetPinnableReference()
    {
        fixed (long* p = &_[0]) return new Span<long>(p, 4);
    }
...
public unsafe struct uint4 : IFixedArray<uint>
{
    ...
    public unsafe Span<uint> GetPinnableReference()
    {
        fixed (uint* p = &_[0]) return new Span<uint>(p, 4);
    }
...
public unsafe struct ulong4 : IFixedArray<ulong>
{
    ...
    public unsafe Span<ulong> GetPinnableReference()
    {
        fixed (ulong* p = &_[0]) return new Span<ulong>(p, 4);
    }
...
public unsafe struct int7 : IFixedArray<int>
{
    ...
    public unsafe Span<int> GetPinnableReference()
    {
        fixed (int* p = &_[0]) return new Span<int>(p, 7);
    }
...
public unsafe struct AVBufferRef_ptr8 : IFixedArray
{
    ...
    public unsafe Span<IntPtr> GetPinnableReference()
    {
        fixed (AVBufferRef** p = &_0) return new Span<IntPtr>(p, 8);
    }
...
public unsafe struct byte_ptr8 : IFixedArray
{
    ...
    public unsafe Span<IntPtr> GetPinnableReference()
    {
        fixed (byte** p = &_0) return new Span<IntPtr>(p, 8);
    }
...
public unsafe struct int8 : IFixedArray<int>
{
    ...
    public unsafe Span<int> GetPinnableReference()
    {
        fixed (int* p = &_[0]) return new Span<int>(p, 8);
    }
...
public unsafe struct ulong8 : IFixedArray<ulong>
{
    ...
    public unsafe Span<ulong> GetPinnableReference()
    {
        fixed (ulong* p = &_[0]) return new Span<ulong>(p, 8);
    }
...
public unsafe struct int9 : IFixedArray<int>
{
    ...
    public unsafe Span<int> GetPinnableReference()
    {
        fixed (int* p = &_[0]) return new Span<int>(p, 9);
    }
...
public unsafe struct AVHDRPlusPercentile15 : IFixedArray<AVHDRPlusPercentile>
{
    ...
    public unsafe Span<AVHDRPlusPercentile> GetPinnableReference()
    {
        fixed (AVHDRPlusPercentile* p = &_0) return new Span<AVHDRPlusPercentile>(p, 15);
    }
...
public unsafe struct AVRational15 : IFixedArray<AVRational>
{
    ...
    public unsafe Span<AVRational> GetPinnableReference()
    {
        fixed (AVRational* p = &_0) return new Span<AVRational>(p, 15);
    }
...
public unsafe struct byte16 : IFixedArray<byte>
{
    ...
    public unsafe Span<byte> GetPinnableReference()
    {
        fixed (byte* p = &_[0]) return new Span<byte>(p, 16);
    }
    public static implicit operator byte[](byte16 @struct) => @struct.ToArray();
}

public unsafe struct byte20 : IFixedArray<byte>
{
    public static readonly int ArrayLength = 20;
    ...
    public byte[] ToArray()
    {
        var a = new byte[20]; for (uint i = 0; i < 20; i++) a[i] = _[i]; return a;
    }
    public void UpdateFrom(byte[] array)
    {
        uint i = 0; foreach(var value in array) { _[i++] = value; if (i >= 20) return; }
    }
    public unsafe Span<byte> GetPinnableReference()
    {
        fixed (byte* p = &_[0]) return new Span<byte>(p, 20);
    }
    public static implicit operator byte[](byte20 @struct) => @struct.ToArray();
}
...
public unsafe struct AVRational25 : IFixedArray<AVRational>
{
    ...
    public unsafe Span<AVRational> GetPinnableReference()
    {
        fixed (AVRational* p = &_0) return new Span<AVRational>(p, 25);
    }
...
public unsafe struct AVRational25x25 : IFixedArray<AVRational25>
{
    ...
    public unsafe Span<AVRational25> GetPinnableReference()
    {
        fixed (AVRational25* p = &_0) return new Span<AVRational25>(p, 25);
    }
