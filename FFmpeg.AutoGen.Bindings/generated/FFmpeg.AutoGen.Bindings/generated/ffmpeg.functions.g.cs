...
public static unsafe partial class ffmpeg
{
    ...
    [DllImport("avformat-if-61", CallingConvention = CallingConvention.Cdecl)]
    public static extern void av_hex_dump(_IO_FILE* @f, byte* @buf, int @size);
    ...
    [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8Marshaler))]
    #endif
    string @fmt, ref __va_list_tag1 @vl);
    ...
    [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8Marshaler))]
    #endif
    string @fmt, ref __va_list_tag1 @vl, byte* @line, int @line_size, int* @print_prefix);
    ...
    /// <param name="st">AVStream that the packet belongs to</param>
    [DllImport("avformat-if-61", CallingConvention = CallingConvention.Cdecl)]
    public static extern void av_pkt_dump2(_IO_FILE* @f, AVPacket* @pkt, int @dump_payload, AVStream* @st);
    ...
    [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8Marshaler))]
    #endif
    string @fmt, ref __va_list_tag1 @ap);
    ...
    /// <param name="dstStride">the array containing the strides for each plane of the destination image</param>
    /// <returns>the height of the output slice</returns>
    public static int sws_scale(SwsContext* @c, ref byte* @srcSlice, int[] @srcStride, int @srcSliceY, int @srcSliceH, byte** @dst, int[] @dstStride)
    {
        fixed (byte** ptr = &@srcSlice)
        {
            return sws_scale(@c, ptr, @srcStride, @srcSliceY, @srcSliceH, @dst, @dstStride);
        }
    }
    ...
    /// <param name="dstStride">the array containing the strides for each plane of the destination image</param>
    /// <returns>the height of the output slice</returns>
    public static int sws_scale(SwsContext* @c, byte** @srcSlice, int[] @srcStride, int @srcSliceY, int @srcSliceH, ref byte* @dst, int[] @dstStride)
    {
        fixed (byte** ptr = &@dst)
        {
            return sws_scale(@c, @srcSlice, @srcStride, @srcSliceY, @srcSliceH, ptr, @dstStride);
        }
    }
    ...
    public unsafe static void Initialize()
    {
        ...
        vectors.av_log_set_formatted_callback = av_log_set_formatted_callback;
        vectors.av_log_set_formatted_filtered_callback = av_log_set_formatted_filtered_callback;
