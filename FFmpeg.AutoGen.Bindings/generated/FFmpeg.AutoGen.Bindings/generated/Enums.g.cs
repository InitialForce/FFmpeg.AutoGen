...
public enum AVActiveFormatDescription : uint
{
    @AV_AFD_SAME = 8,
    @AV_AFD_4_3 = 9,
    @AV_AFD_16_9 = 10,
...
public enum AVAudioServiceType : uint
{
...
public enum AVChannelOrder : uint
{
...
public enum AVChromaLocation : uint
{
...
public enum AVClassCategory : uint
{
...
public enum AVCodecConfig : uint
{
...
public enum AVColorPrimaries : uint
{
...
public enum AVColorTransferCharacteristic : uint
{
...
public enum AVDurationEstimationMethod : uint
{
...
public enum AVFrameSideDataType : uint
{
...
public enum AVHDRPlusOverlapProcessOption : uint
{
    @AV_HDR_PLUS_OVERLAP_PROCESS_WEIGHTED_AVERAGING = 0,
    @AV_HDR_PLUS_OVERLAP_PROCESS_LAYERING = 1,
}

public enum AVHWDeviceType : uint
{
...
public enum AVHWFrameTransferDirection : uint
{
...
public enum AVIODataMarkerType : uint
{
...
public enum AVIODirEntryType : uint
{
...
public enum AVMatrixEncoding : uint
{
...
public enum AVPacketSideDataType : uint
{
...
/// <summary>@{</summary>
public enum AVPictureStructure : uint
{
...
/// <summary>@} @}</summary>
public enum AVPictureType : uint
{
...
public enum AVSideDataProps : uint
{
...
public enum AVStreamGroupParamsType : uint
{
...
/// <summary>@}</summary>
public enum AVSubtitleType : uint
{
    @SUBTITLE_NONE = 0,
...
public enum AVTimecodeFlag : uint
{
...
public enum SwrDitherType : uint
{
    @SWR_DITHER_NONE = 0,
...
public enum SwrFilterType : uint
{
