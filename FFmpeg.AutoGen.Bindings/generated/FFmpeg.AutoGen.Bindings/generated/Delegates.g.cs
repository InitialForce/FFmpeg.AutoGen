...
public unsafe delegate void av_log_set_callback_callback (void* @p0, int @p1,
    ...
    #endif
    string @p2, ref __va_list_tag1 @p3);
...
[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
public unsafe delegate void av_log_set_formatted_callback_p0 (void* @p0, int @p1,
    #if NETSTANDARD2_1_OR_GREATER
    [MarshalAs(UnmanagedType.LPUTF8Str)]
    #else
    [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8Marshaler))]
    #endif
    string @p2);
public unsafe struct av_log_set_formatted_callback_p0_func
{
    public IntPtr Pointer;
    public static implicit operator av_log_set_formatted_callback_p0_func(av_log_set_formatted_callback_p0 func) => new av_log_set_formatted_callback_p0_func { Pointer = func == null ? IntPtr.Zero : Marshal.GetFunctionPointerForDelegate(func) };
}

[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
public unsafe delegate void av_log_set_formatted_filtered_callback_p0 (void* @p0, int @p1,
    #if NETSTANDARD2_1_OR_GREATER
    [MarshalAs(UnmanagedType.LPUTF8Str)]
    #else
    [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8Marshaler))]
    #endif
    string @p2);
public unsafe struct av_log_set_formatted_filtered_callback_p0_func
{
    public IntPtr Pointer;
    public static implicit operator av_log_set_formatted_filtered_callback_p0_func(av_log_set_formatted_filtered_callback_p0 func) => new av_log_set_formatted_filtered_callback_p0_func { Pointer = func == null ? IntPtr.Zero : Marshal.GetFunctionPointerForDelegate(func) };
}
