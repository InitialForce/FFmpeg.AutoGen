...
public static unsafe partial class DllImportBindings
{
    ...
    [DllImport("avformat-if-61", CallingConvention = CallingConvention.Cdecl)]
    ...
    /// <returns>b+c</returns>
    [DllImport("avutil-if-59", CallingConvention = CallingConvention.Cdecl)]
    ...
    [DllImport("avcodec-if-61", CallingConvention = CallingConvention.Cdecl)]
    ...
    [DllImport("avfilter-if-10", CallingConvention = CallingConvention.Cdecl)]
    ...
    [DllImport("avdevice-if-61", CallingConvention = CallingConvention.Cdecl)]
    ...
    [DllImport("avutil-if-59", CallingConvention = CallingConvention.Cdecl)]
    public static extern void av_log_set_formatted_callback(av_log_set_formatted_callback_p0_func @p0);
    
    [DllImport("avutil-if-59", CallingConvention = CallingConvention.Cdecl)]
    public static extern void av_log_set_formatted_filtered_callback(av_log_set_formatted_filtered_callback_p0_func @p0);
    ...
    [DllImport("swresample-if-5", CallingConvention = CallingConvention.Cdecl)]
    ...
    [DllImport("swscale-if-8", CallingConvention = CallingConvention.Cdecl)]
