...
public unsafe struct AVRational_array3x2 : IFixedArray<AVRational_array2>
{
    ...
    #if NETSTANDARD2_1_OR_GREATER || NETCOREAPP2_1_OR_GREATER
    public unsafe Span<AVRational_array2> GetPinnableReference()
    {
        fixed (AVRational_array2* p = &_0) return new Span<AVRational_array2>(p, 3);
    }
    #endif
...
public unsafe struct short_array3x2 : IFixedArray<short_array2>
{
    ...
    #if NETSTANDARD2_1_OR_GREATER || NETCOREAPP2_1_OR_GREATER
    public unsafe Span<short_array2> GetPinnableReference()
    {
        fixed (short_array2* p = &_0) return new Span<short_array2>(p, 3);
    }
    #endif
...
public unsafe struct byte_array8 : IFixedArray<byte>
{
    ...
    public unsafe Span<byte> GetPinnableReference()
    {
        fixed (byte* p = &_[0]) return new Span<byte>(p, 8);
    }
    #endif
...
public unsafe struct AVRational_array25x25 : IFixedArray<AVRational_array25>
{
    ...
    #if NETSTANDARD2_1_OR_GREATER || NETCOREAPP2_1_OR_GREATER
    public unsafe Span<AVRational_array25> GetPinnableReference()
    {
        fixed (AVRational_array25* p = &_0) return new Span<AVRational_array25>(p, 25);
    }
    #endif
